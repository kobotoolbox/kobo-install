...
services:
  kobocat:
    ...
    ${USE_EXTRA_HOSTS}extra_hosts:
      ...
      ${ADD_BACKEND_EXTRA_HOSTS}- postgres.${PRIVATE_DOMAIN_NAME}:${MASTER_BACKEND_IP}
      ${ADD_BACKEND_EXTRA_HOSTS}- mongo.${PRIVATE_DOMAIN_NAME}:${MASTER_BACKEND_IP}
      ${ADD_BACKEND_EXTRA_HOSTS}- redis-main.${PRIVATE_DOMAIN_NAME}:${MASTER_BACKEND_IP}
      ${ADD_BACKEND_EXTRA_HOSTS}- redis-cache.${PRIVATE_DOMAIN_NAME}:${MASTER_BACKEND_IP}
