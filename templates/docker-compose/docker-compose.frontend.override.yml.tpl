...
services:
  ...
  nginx:
    environment:
      - ENKETO_EXPRESS_PUBLIC_PORT=${NGINX_PORT}
      - TEMPLATED_VAR_REFS=$$$${ENKETO_EXPRESS_PUBLIC_PORT} $$$${INTERNAL_DOMAIN_NAME} $$$${PUBLIC_DOMAIN_NAME} $$$${KOBOFORM_PUBLIC_SUBDOMAIN} $$$${KOBOCAT_PUBLIC_SUBDOMAIN} $$$${ENKETO_EXPRESS_PUBLIC_SUBDOMAIN}
    ports:
      - ${NGINX_PORT}:80
    ${USE_DNS}extra_hosts:
      ${USE_PUBLIC_DNS}- ${KOBOFORM_SUBDOMAIN}.${PUBLIC_DOMAIN_NAME}:${LOCAL_INTERFACE_IP}
