...
${USE_AWS_CREDENTIALS}AWS_ACCESS_KEY_ID=${AWS_ACCESS_KEY_ID}
${USE_AWS_CREDENTIALS}AWS_SECRET_ACCESS_KEY=${AWS_SECRET_ACCESS_KEY}
${USE_AWS_PROFILE}AWS_PROFILE=${AWS_PROFILE}
${USE_AWS_PROFILE}AWS_CONFIG_FILE=/home/kobo/.aws/config
