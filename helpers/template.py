...
class Template:
    ...
    def __get_template_variables(config):
        ...
        return {
            ...
            'DEBUG': dict_['debug', False] is True,
            ...
            'POSTGRES_PORT': dict_['postgresql_port', '5432'],
            'MONGO_PORT': dict_['mongo_port', '27017'],
            'REDIS_MAIN_PORT': dict_['redis_main_port', '6739'],
            'REDIS_CACHE_PORT': dict_['redis_cache_port', '6380'],
            'USE_BACKUP': '' if dict_[
